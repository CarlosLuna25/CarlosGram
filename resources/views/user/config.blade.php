                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('user.update') }}" enctype="multipart/form-data" aria-label="{{ __('Register') }}">
                        ...
                        <div class="form-group row align-content-center">
                         <label for="image_path" class="col-md-4 col-form-label text-md-right">{{ __('Avatar actual') }}</label>
                            <div class="col-md-6 ">

                             @if (Auth::user()->image != null)

                                 <img class="rounded-circle ml-2" width=50 height=50 src="{{ action('userController@getimg', ['filename'=>\Auth::user()->image]) }} " alt=""> 
                            @endif
                            </div>
                        </div>
                        <div class="form-group row">
                        
                            <label for="image_path" class="col-md-4 col-form-label text-md-right">{{ __('Cambiar Avatar') }}</label>
